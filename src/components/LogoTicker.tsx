...
import { Montserrat_Alternates } from "next/font/google"; // Import Google Font

// Initialize the Montserrat Alternates font
const montserratAlternates = Montserrat_Alternates({
  weight: "400", // Default weight
  subsets: ["latin", "cyrillic"], // Cyrillic for Bulgarian text
